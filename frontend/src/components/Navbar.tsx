        ...
        <div className="max-w-7xl mx-auto px-6 h-16 md:h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            {isLandingPage ? (
              ...
              <Link to="/#pricing" className="bg-stone-900 dark:bg-white text-[#FFFCF8] dark:text-zinc-900 px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-stone-800 dark:hover:bg-zinc-200 transition-all hover:-translate-y-0.5 active:translate-y-0 shadow-sm">
                Get Started
              </Link>
            )}
          </div>
